...
declare module 'weapp-vite/auto-routes' {
  export type AutoRoutesPages = readonly ['pages/index/index', 'pages/screen/screen']
  export type AutoRoutesEntries = readonly ['pages/index/index', 'pages/screen/screen']
